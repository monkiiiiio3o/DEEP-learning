...
# 读取验证集的英文原文和中文参考
with open('C:/Users/Monki/Desktop/deep-learing/en2cn/valid_en.txt', 'r', encoding='utf-8') as f:
    src_sentences = [line.strip() for line in f.readlines()]

with open('C:/Users/Monki/Desktop/deep-learing/en2cn/valid_zh.txt', 'r', encoding='utf-8') as f:
