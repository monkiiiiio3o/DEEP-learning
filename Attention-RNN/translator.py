...
sp_en.load('D:/DEEP-learning/en_bpe.model')
sp_cn = spm.SentencePieceProcessor()
sp_cn.load('D:/DEEP-learning/zh_bpe.model')
...
class Attention(nn.Module):
    def __init__(self, hid_dim):
        ...
        self.attn = nn.Linear(hid_dim * 2 + hid_dim, hid_dim)#注意：将维度转化为hid_dim
        #输出一个代表注意力的logit值
...
if __name__ == '__main__':
    ...
    dataset = TranslationDataset('C:/Users/Monki/Desktop/deep-learing/en2cn/train_en.txt', 'C:/Users/Monki/Desktop/deep-learing/en2cn/train_zh.txt', tokenize_en, tokenize_cn)
